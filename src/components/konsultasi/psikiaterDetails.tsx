...
interface PsikiaterDetailsProps {
    ...
    return (
        <div>
            <div className="absolute w-[590px] p-[40px] items-center justify-center bg-secondary shadow-lg">
                <div className="flex flex-col">
                    ...
                    <div className="flex justify-between items-center mt-[15px]">
                        ...
                        <div>
                            <div 
                                className="px-[30px] py-[10px] text-button text-secondary bg-primary2 hover:brightness-110"
                                onClick={togglePopup}
                            >
                                JADWALKAN SEKARANG
                            </div>
            ...
            {isOpen && (
                <>
                <div className="fixed inset-0 z-40 bg-[rgba(217,217,217,0.25)]"></div>
                <div className="absolute left-5 w-[550px] z-50 py-[30px] px-[25px] bg-secondary">
                    <div className="flex flex-col justify-center items-center text-center">
                    <Image className="mt-[30px]" src="/images/success.svg" alt="sukses" height={320} width={320}/>
                    <p className="text-heading3 my-[16px]">Kamu berhasil mengeset appointment!</p>
                    <p className="mx-[50px] mb-[16px]">Jangan lupa untuk melakukan konsultasi dengan psikiatermu pada tanggal $tanggalKonsultasi via whatsapp: $noWhatsapp</p>
                    <Link href="../" className="text-button text-secondary bg-primary2 px-[92.5px] py-[10px]">OK</Link>
                    </div>
                </div>
                </>
            )}
